    ...
    <?php foreach($orders as $order): ?>
      <tr class="even pointer">
        ...
        <?php if($order->payment->paid): ?>
        	<td class=" "><button class="btn btn-success btn-xs">Betaald</button></td>
        <?php else: ?>
        	<td class=" "><button class="btn btn-primary btn-xs">Openstaand</button></td>
        <?php endif; ?>
        <td class=" last"><a href="/admin/order/<?php echo e($order->id); ?>" class="btn btn-primary btn-xs">Details</a></td>
      </tr>
    <?php endforeach; ?>
    </tbody>
  </table>
